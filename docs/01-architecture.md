...
3. **Frontend (the faithful port).** Tokenizer, then parser, then analyzer, ported file for file from Godot 4.6.3-stable. Each stage emits diagnostics with Godot-matching codes, messages, and source ranges. Detail: `02-frontend-port.md`.
