...
| **Status** | Phase 2 definition — authoritative scope for everything post-v1.0.5. Supersedes the one-row "Phase 2" sketches in `docs/00 §3`, `docs/05 §1`, `docs/07 §1`, and `docs/08 §4`. |
